...
def evaluate(groundtruth, parsedresult):
    ...
    # df_parsedlog['LineId'] = range(1, len(df_parsedlog) + 1)
...
if __name__ == '__main__':
    # evaluate(f"dataset/Android/Android_2k.log_structured_corrected_444.csv", f"output.csv")
    print("Group Accuracy: 0.4156")